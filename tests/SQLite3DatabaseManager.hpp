...
class SQLite3DatabaseManager : public IDatabaseManager {
public:
    explicit SQLite3DatabaseManager(const std::string& dbPath = ":memory:") {
    ...
    SQLite3DatabaseManager(SQLite3DatabaseManager&& other) noexcept : db_(other.db_) {
        other.db_ = nullptr;
    }
